...
@section('content')
    <div style="padding: 1.5rem 2rem 1rem 2rem">
        ...
        <table style="width:100%">
            <tbody>
            @if($button)
                <a href="/offer/contract-print/{{ $offer->id }}/Eng">
        ...
        <table style="width:100%">
            ...
            <tr>
                <td class="paragraph" style="text-align: right">
                    <strong>
                        Advance payment: {!! fixEuro(numfmt_format_currency($fmt, ($offer->total_with_vat + $offer->balance), $settings->currency->code)) !!} </strong>
                </td>
            </tr>
            <tr>
                <td class="paragraph" style="text-align: right">
                    <strong> Rest payment: {!! fixEuro(numfmt_format_currency($fmt, abs($offer->balance), $settings->currency->code)) !!} </strong>
                </td>
            </tr>
            </tbody>
        </table>
