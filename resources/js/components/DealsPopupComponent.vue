            ...
            <div class="popup-inner">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 p-0">
                        ...
                        <div class="float-right drop-new" v-if="offer.company_id === 0 && offer.company_name.length > 2">New</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 p-0">
                        ...
                        <div class="float-right drop-new" v-if="offer.contact_id === 0 && offer.contact_name.length > 2">New</div>
                ...
                <div class="form-group row">
                    ...
                    <input id="title" type="text" class="form-control col-md-8" name="title" v-model="offer.title">
                </div>

                <div class="form-group row">
                    <label class="col-md-4 text-right col-form-label" for="pipeline">Sales Pipeline</label>
                    <input id="pipeline" type="text" class="form-control col-md-8" name="pipeline" v-model="offer.pipeline">
                </div>

                <div class="form-group row">
                    <label class="col-md-4 text-right col-form-label" for="state_id">Stage</label>
                    <select id="state_id" type="text" class="form-control col-md-8" name="state_id" v-model="offer.state_id">
                ...
                <div class="form-group row">
                    ...
                    <input id="probability" type="text" class="form-control col-md-8" name="probability" v-model="offer.probability">
                </div>

                <div class="form-group row">
                    <label class="col-md-4 text-right col-form-label" for="comment">Comment</label>
                    <input id="comment" type="text" class="form-control col-md-8" name="comment" v-model="offer.comment">
                </div>

                <div class="form-group row">
                    <label class="col-md-4 text-right col-form-label" for="person_id">Person</label>

                    <select id="person_id" type="text" class="form-control col-md-8" name="person_id" v-model="offer.person_id">
                        <option v-for="person in persons" v-bind:value="person.id">{{ person.name }}</option>
                    </select>
                </div>

                <div class="form-group text-right">
                    <button class="btn btn-outline-info" type="button" @click="closePopup"><i class="fas fa-times"></i> Cancel
                    </button>
...
export default {
    ...
    methods: {
        ...
        getContact(e) {
            ...
            axios.post('/get-contacts', {name: this.offer.contact_name, companyId: this.offer.company_id}).then(response => {
